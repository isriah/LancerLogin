...
3. Inspect the final diff, commit only the intended release-preparation files, and push `main`.
4. Wait for the exact pushed commit's public GitHub Verify workflow to pass. Do not tag a different commit or change the version to bypass a failed gate.
