...
export function AppShell({ role, branding, onBrandingChanged, onSignedOut, themeControl }: { themeControl: React.ReactNode; role: "admin" | "operator"; branding: Branding; onBrandingChanged: (branding: Branding) => void; onSignedOut: () => void }) {
