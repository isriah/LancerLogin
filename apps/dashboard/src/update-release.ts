...
export async function fetchLatestRelease(
  ...
  publicUpdatesDisabled = import.meta.env?.VITE_DISABLE_PUBLIC_UPDATES === "true",
): Promise<Release> {
  if (publicUpdatesDisabled) throw new Error("Public release updates are disabled for this development installation.");
