...
# tar can replace the destination mode with the archive root mode. Code must
# remain traversable by the service account; private state above stays 0700.
chmod 0755 /opt/lancerlogin
