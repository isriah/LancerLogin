...
export const maintenanceLayoutStyles = `.form-row{grid-template-columns:minmax(0,1fr) minmax(0,72px)}.form-row>*{min-width:0}.form-row input,.form-row select{width:100%;min-width:0}.pin-keypad button{width:100%;min-width:0}.number-sheet{padding:8px;overflow:hidden}.sheet-panel.small{width:min(310px,calc(100vw - 16px));max-width:100%;overflow:hidden}`;
