...
let state = { paired: false, readerOnline: false, cloudOnline: false, networkType: undefined, kioskName: undefined, lastSyncAt: undefined, errorCategory: undefined };
