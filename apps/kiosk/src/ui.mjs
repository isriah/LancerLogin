...
<body><main id="kiosk" class="kiosk-shell kiosk-shell-ready" aria-live="polite">
  <button id="network-status" class="network-status" type="button" aria-label="Network status" title="Network status"><span aria-hidden="true">●</span></button>
  <button id="maintenance-status" class="maintenance-status" type="button" aria-label="Fingerprint maintenance" title="Fingerprint maintenance">FP</button>
  ...
  <footer class="debug-status"><span id="reader-status">Reader starting…</span><span id="queue-status">No scans waiting</span><span id="clock"></span></footer>
</main>
...
export const kioskStyles = `:root{--page-bg:#f4f6f8;--surface-bg:#424a53;--text-color:#17202a;--on-surface-color:#ffffff;--on-primary-color:#ffffff;--muted-color:color-mix(in srgb,var(--on-surface-color),var(--surface-bg) 22%);--border-color:#d8dee6;--primary:#b80100;--secondary:#f2c14e;--primary-color:var(--primary);--accent-color:var(--secondary);--success-pulse-color:#178f4f;--failure-flash-color:#ff2a24;--network-online-color:#33d17a;--network-queued-color:#f2c14e;--network-offline-color:#ff5b57;--network-unknown-color:color-mix(in srgb,var(--on-surface-color),var(--surface-bg) 42%);--idle-mark-color:color-mix(in srgb,var(--surface-bg),#000000 34%);--primary-dark:color-mix(in srgb,var(--primary-color),#000000 26%);--accent-dark:color-mix(in srgb,var(--accent-color),#000000 38%);--danger-color:color-mix(in srgb,var(--accent-color),#8b0000 58%);font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--on-surface-color);background:var(--surface-bg);color-scheme:dark}*{box-sizing:border-box}html,body{width:100%;height:100%;margin:0;overflow:hidden;background:var(--surface-bg)}button,textarea{font:inherit}.kiosk-shell{width:100%;height:100vh;min-height:100%;display:grid;grid-template-rows:auto 1fr auto;align-items:center;justify-items:center;padding:32px;background:var(--surface-bg)}.kiosk-shell-welcome,.kiosk-shell-goodbye,.kiosk-shell-enroll_success{animation:success-pulse 1100ms ease-out 2}.kiosk-shell-rejected,.kiosk-shell-unknown,.kiosk-shell-enroll_failure{animation:failure-flash 360ms ease-in-out 4}.network-status,.maintenance-status{position:fixed;z-index:3;top:14px;width:84px;height:84px;display:grid;place-items:center;border:0;background:transparent;color:var(--network-unknown-color);padding:0;cursor:default;touch-action:none;user-select:none;-webkit-user-select:none;line-height:1}.network-status{left:14px;font-size:48px}.maintenance-status{right:14px;border:3px solid currentColor;border-radius:50%;font-size:20px;font-weight:900}.network-status span{display:block;width:48px;height:48px;border:6px solid currentColor;border-radius:50%;font-size:0}.network-status span::after{content:"";position:absolute;right:8px;bottom:8px;width:13px;height:13px;border-radius:50%;background:currentColor;box-shadow:0 0 0 3px var(--surface-bg)}.network-status.online{color:var(--network-online-color)}.network-status.offline{color:var(--network-offline-color)}.kiosk-brand{width:min(720px,100%);display:grid;grid-template-columns:minmax(0,1fr) minmax(76px,auto) minmax(0,1fr);align-items:center;gap:16px;color:var(--muted-color);font-size:20px;margin-bottom:20px}.kiosk-brand #brand-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:right}.kiosk-brand strong{color:var(--on-surface-color);font-size:22px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:left}.adaptive-logo{height:60px;min-width:76px;max-width:180px;display:grid;place-items:center;padding:6px;border:1px solid rgb(255 255 255 / 32%);border-radius:12px}.adaptive-logo img{max-width:100%;max-height:100%;display:block;object-fit:contain}.adaptive-logo.backdrop-light{background:#fff}.adaptive-logo.backdrop-dark{background:#111315}.adaptive-logo.backdrop-none{padding:0;border-color:transparent;background:transparent}.scan-panel{width:min(720px,100%);min-height:320px;display:grid;justify-items:center;align-content:center;gap:24px;background:transparent;border:0;text-align:center}.reader-mark{width:132px;height:132px;border-radius:50%;border:14px solid var(--idle-mark-color);box-shadow:inset 0 0 0 18px var(--accent-color)}.scan-panel-welcome .reader-mark,.scan-panel-goodbye .reader-mark,.scan-panel-enroll_scan_accepted .reader-mark,.scan-panel-enroll_success .reader-mark{border-color:var(--primary-dark);box-shadow:inset 0 0 0 18px var(--accent-color)}.scan-panel-processing .reader-mark,.scan-panel-duplicate .reader-mark,.scan-panel-enroll_wait_first .reader-mark,.scan-panel-enroll_wait_second .reader-mark{border-color:var(--accent-dark);box-shadow:inset 0 0 0 18px var(--accent-color)}.scan-panel-rejected .reader-mark,.scan-panel-unknown .reader-mark,.scan-panel-offline .reader-mark,.scan-panel-reader_offline .reader-mark,.scan-panel-enroll_failure .reader-mark{border-color:var(--danger-color);box-shadow:inset 0 0 0 18px var(--accent-color)}h1{margin:0;font-size:48px;line-height:1.08;font-weight:800}p{margin:0;font-size:24px;color:var(--muted-color)}#display-name{color:var(--on-surface-color);font-size:30px;font-weight:800}#display-meeting{font-size:20px;color:var(--accent-color);font-weight:800}.debug-status{width:min(720px,100%);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px;margin-top:20px;color:var(--muted-color);font-size:18px}.pairing-overlay{position:fixed;z-index:10;inset:0;display:grid;place-items:center;padding:24px;background:color-mix(in srgb,var(--surface-bg),#000 22%)}.pairing-overlay[hidden]{display:none}.pairing-card{width:min(680px,100%);display:grid;gap:14px;padding:30px;border-radius:22px;background:var(--page-bg);color:var(--text-color);box-shadow:0 18px 60px rgb(0 0 0 / 35%)}.pairing-card h2,.pairing-card p{margin:0}.pairing-card h2{font-size:36px}.eyebrow{color:color-mix(in srgb,var(--text-color),var(--page-bg) 35%);font-size:16px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.pairing-card label{font-weight:800}.pairing-card textarea{width:100%;min-height:116px;padding:12px;border:2px solid var(--border-color);border-radius:12px;background:#fff;color:var(--text-color);resize:none}.pairing-card button{min-height:58px;border:0;border-radius:12px;background:var(--primary-color);color:var(--on-primary-color);font-weight:900}.pairing-card textarea:focus-visible,.pairing-card button:focus-visible,.network-status:focus-visible,.maintenance-status:focus-visible{outline:4px solid #f7c948;outline-offset:3px}@media(max-height:520px){.kiosk-shell{padding:20px 32px}.kiosk-brand{font-size:18px;margin-bottom:10px}.kiosk-brand strong{font-size:20px}.adaptive-logo{height:54px;min-width:68px}.scan-panel{min-height:286px;gap:16px}.reader-mark{width:108px;height:108px;border-width:12px;box-shadow:inset 0 0 0 15px var(--accent-color)}h1{font-size:42px}p{font-size:21px}.debug-status{margin-top:10px;font-size:16px}.network-status,.maintenance-status{top:10px;width:68px;height:68px}.network-status{left:10px}.maintenance-status{right:10px;font-size:17px}.network-status span{width:42px;height:42px}}@keyframes success-pulse{0%,100%{background:var(--surface-bg)}45%{background:var(--success-pulse-color)}}@keyframes failure-flash{0%,100%{background:var(--surface-bg)}50%{background:var(--failure-flash-color)}}@media(prefers-reduced-motion:reduce){.kiosk-shell-welcome,.kiosk-shell-goodbye,.kiosk-shell-enroll_success,.kiosk-shell-rejected,.kiosk-shell-unknown,.kiosk-shell-enroll_failure{animation:none}}`;
...
function render(value) {
  ...
  network.className = "network-status " + (value.cloudOnline ? "online" : "offline");
  network.title = value.cloudOnline ? "Cloud connected" : "Cloud connection unavailable";
...
let maintenanceHold;
byId("brand").addEventListener("pointerdown", () => { maintenanceHold = setTimeout(() => { location.href = "/maintenance"; }, 3000); });
for (const event of ["pointerup", "pointercancel", "pointerleave"]) byId("brand").addEventListener(event, () => clearTimeout(maintenanceHold));
byId("maintenance-status").addEventListener("click", () => { location.href = "/maintenance"; });
function clock() { byId("clock").textContent = new Date().toLocaleTimeString([], { hour: "numeric", minute: "2-digit" }); }
clock();
