...
- Local salted-scrypt and Google OAuth authentication; immediate active-user/current-role session revalidation; Admin/Operator enforcement; user administration; Google-only lockout prevention; interactive local recovery.
