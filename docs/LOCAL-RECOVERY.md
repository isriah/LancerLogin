...
The stable public release is v1.2.3. The completed migration used the terminal Pi updater successfully, while dashboard-driven Pi release lookup acceptance remains unproven. Treat a dashboard error or absent completion status as unconfirmed, not as proof that an update ran.
