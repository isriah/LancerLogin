...
| 4 | Guided Pi installer, R503 protocol, local mappings, persistent offline queue, hashed pairing, kiosk health | Complete with injected serial transport; physical hardware acceptance pending |
