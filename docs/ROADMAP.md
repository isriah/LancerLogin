...
| 7 | Consent-gated telemetry runtime, isolated collector, privacy notice, CSV and D1 backup/restore | Runtime, collector, public RoboLancers governance, 30-day retention, aggregate access, and deletion route complete; fresh endpoint deployment pending |
