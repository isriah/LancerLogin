...
Release: `v0.22.2`; supported-server validation follows the private upgrade because the guarded adopter workflow installs published stable tags only.
