...
try {
  ...
  if (!(schema.get("kiosk_commands") ?? "").includes("reset_network_pin") || !(schema.get("idx_kiosk_commands_pending") ?? "").includes("completed_at")) throw new Error("Final D1 schema is missing the authenticated kiosk command queue");
