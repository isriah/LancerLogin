...
try {
  ...
  if (!installationSql.includes("google_enabled") || !installationSql.includes("resend_enabled") || !installationSql.includes("discord_enabled")) throw new Error("Final D1 schema is missing explicit integration enablement flags");
