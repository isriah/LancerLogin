...
test("roster renders authoritative server policy rates", () => {
  ...
  assert.deepEqual(result.rates.one, { regularAttendance: report.members[0].regularAttendance, currentCompliances: [], currentCompliance: report.members[0].currentCompliance, complete: true });
  assert.deepEqual(result.rates.two, { regularAttendance: report.members[1].regularAttendance, currentCompliances: report.members[1].currentCompliances, currentCompliance: report.members[1].currentCompliance, complete: true });
});
