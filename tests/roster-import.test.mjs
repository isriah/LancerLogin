...
test("roster CSV accepts optional contact and Discord fields", () => {
  const result = parseRosterCsv("memberId,firstName,lastName,email,discordUserId\n1,Ada,Lovelace,ada@example.test,123");
  assert.deepEqual(result, { rows: [{ memberId: "1", firstName: "Ada", lastName: "Lovelace", email: "ada@example.test", discordUserId: "123" }], errors: [] });
});
